...
class _ajouterannonceState extends State<ajouterannonce> {
  ...
  static const CameraPosition _kGooglePlex = CameraPosition(
      target: LatLng(36.66341269293006, 4.912070512984503), zoom: 15);
  static const CameraPosition _kGooglePlex1 = CameraPosition(
      target: LatLng(36.6612957999728, 4.914423362670078), zoom: 15);
  bool value = false;
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Container(
            padding:
                EdgeInsets.fromLTRB(25 * fem, 15 * fem, 25 * fem, 30 * fem),
            width: double.infinity,
              ...
              children: <Widget>[
                ...
                counter == 0
                    ? Column(children: [
                        ...
                        Container(
                          margin: EdgeInsets.fromLTRB(
                              24 * fem, 0 * fem, 23 * fem, 25 * fem),
                          padding: EdgeInsets.fromLTRB(
                              21 * fem, 10 * fem, 21 * fem, 10 * fem),
                          width: double.infinity,
                          height: 45 * fem,
                          decoration: BoxDecoration(
                            color: clair,
                        ...
                        Container(
                          margin: EdgeInsets.fromLTRB(
                              24 * fem, 0 * fem, 23 * fem, 13 * fem),
                          padding: EdgeInsets.fromLTRB(
                              21 * fem, 5 * fem, 21 * fem, 16 * fem),
                          width: double.infinity,
                          height: 63 * fem,
                          decoration: BoxDecoration(
                            color: clair,
