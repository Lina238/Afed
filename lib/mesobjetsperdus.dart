...
import'home-4.dart';
class mesperdus extends StatefulWidget {
  const mesperdus({Key? key}) : super(key: key);

  @override
  State<mesperdus> createState() => _mesperdusState();
}

class _mesperdusState extends State<mesperdus> {
  @override
...
//////////////////////////////widgets//////////////////////////////////////
  Container buildobjet(double fem, double ffem, int index, String dat,
      String nbmessages, String nbvues) {
    return Container(
