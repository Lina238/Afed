...
class Homestate extends State<home> {
              ...
              Row(
                ...
                children: <Widget>[
                  MaterialButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => Notificat()));
                      setState(() {
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => ajouterannonce()));
        },
  ...
  Container objtperdu(double fem, double ffem) {
    List<Objetslist> perdulst = [
      Objetslist(
          fem: fem,
          ffem: ffem,
          phrase: "j'ai perdu ma veste wesh",
          photo: "",
          userpic: "assets/page-1/images/user-1.png",
          name: "linaben"),
      Objetslist(
          fem: fem,
          ffem: ffem,
          phrase: "j'ai perdu ma voiture",
          photo: "assets/page-1/images/isaac-smith-ucjsz6zqzio-unsplash-1.png",
          userpic: "assets/page-9/images/user-6.png",
          name: "Bachir bouras"),
      Objetslist(
          fem: fem,
          ffem: ffem,
          phrase: "j'ai perdu ma motivation :(",
          photo: "",
          userpic: "assets/page-1/images/user-1.png",
          name: "Benyahia Lina"),
      Objetslist(
          fem: fem,
          ffem: ffem,
          phrase: "j'ai perdu ma voiture wesh",
          photo: "assets/page-1/images/isaac-smith-ucjsz6zqzio-unsplash-1.png",
          userpic: "assets/page-1/images/user-1.png",
          name: "Benyahia Lina"),
      Objetslist(
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return buildobjet(
              fem, ffem, ob.phrase, ob.photo, ob.userpic, ob.name!);
        },
      ),
    );
  }
  ...
  Container objttrv(double fem, double ffem) {
    List<Objetslist> trouvlist = [
      Objetslist(
          fem: fem,
          ffem: ffem,
          phrase: "j'ai trouvé une veste c'est à qui?",
          photo: "",
          userpic: "assets/page-1/images/user-1.png",
          name: "Benyahia Lina"),
      Objetslist(
          fem: fem,
          ffem: ffem,
          phrase: "j'ai trouvé cette voiture",
          photo: "assets/page-1/images/isaac-smith-ucjsz6zqzio-unsplash-1.png",
          userpic: "assets/page-9/images/user-6.png",
          name: "Bachir bouras"),
      Objetslist(
          fem: fem,
          ffem: ffem,
          phrase: "j'ai trouvé ta  motivation lina arwah",
          photo: "",
          userpic: "assets/page-1/images/user-1.png",
          name: "Benyahia Lina"),
      Objetslist(
  ...
  Widget buildobjet(double fem, double ffem, String p, String photoobj,
      String userpic, String name) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Container(
            margin:
                EdgeInsets.fromLTRB(0 * fem, 0 * fem, 100 * fem, 16.5 * fem),
            width: double.infinity,
            height: 50 * fem,
            child: userid(fem, ffem, userpic, name),
          ),
          //description
          Container(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Container(
            margin:
                EdgeInsets.fromLTRB(0 * fem, 0 * fem, 227.95 * fem, 0 * fem),
            width: 97.99 * fem,
            height: 25.98 * fem,
            child: Image.asset(
