...
class _ProfilePageState extends State<ProfilePage> {
          ...
          Padding(
              ...
              child: GestureDetector(
                  ...
                  child: ImageIcon(
                    color: retour,
                    AssetImage(
                        "assets/page-8/images/arrow-right-from-bracket-solid-1.png"),
                    size: 29 * fem,
                  )))
        ],
      ),
                  ...
                  children: [
                    Container(
                      ...
                      child: Stack(
                        ...
                        children: [
                          ...
                          Container(
                            margin:
                                EdgeInsets.fromLTRB(0, 80 * fem, 0, 20 * fem),
                    ...
                    Container(
                      ...
                      itemms(
                          fem,
                          ffem,
                          'assets/page-8/images/auto-group-dddt.png',
                          'Informations personnelles',
                          ProfileInfo()),
                      itemms(
                          fem,
                          ffem,
                          'assets/page-8/images/auto-group-ugb4.png',
                          'Mes objets  perdus',
                          mesperdus()),
                      itemms(
                          fem,
                          ffem,
                          'assets/page-8/images/auto-group-zwbc.png',
                          'Mes objets trouvés',
                          mestrouves()),
                      itemms(
                          fem,
                          ffem,
                          'assets/page-8/images/auto-group-xbxe.png',
                          'Nous contacter',
                          contactus()),
                    ]))
                  ])),
  ...
  GestureDetector itemms(
      double fem, double ffem, String Icnimg, String tx, Widget pj) {
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(builder: (context) => pj));
        ;
      },
      child: Container(
          width: double.infinity,
          child: Column(
            ...
            children: [
              Container(
                margin:
                    EdgeInsets.fromLTRB(50 * fem, 15 * fem, 50 * fem, 0 * fem),
                padding:
                    EdgeInsets.fromLTRB(24 * fem, 13 * fem, 24 * fem, 13 * fem),
                width: double.infinity,
                decoration: BoxDecoration(
